...
import NewUser from '@/app/(pages)/components/inviteCode/InvitePage/NewUser'
  ...
  return (
    ...
    <InviteUpper serverName={server.name} memberName={server.Members[0].user?.name as string} />
        ...
        <div className='invite_lower'>
            {/* <ContinueEmail  /> */}
            <NewUser serverName={server.name} emailId={params?.emailId} inviteCode={params?.inviteCode} />
        </div>
    </div>
