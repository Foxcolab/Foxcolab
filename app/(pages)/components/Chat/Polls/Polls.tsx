        ...
        <div className="flex flex-col w-full">
          <div className="flex items-center gap-x-2 ">
                ...
                </div>
            {
                            ...
                            <div key={i} className='flex items-center gap-2 poll_single_option'>
                                {
                                    ...
                                    <input type="radio" value={option} className='radio cursor-pointer' name={poll.id} checked={myVotes.includes(option)} onChange={(e)=>CheckHandler(e.target.value)} />
                                     : 
                                    <input type='checkbox' value={option} className='checkbox cursor-pointer' checked={myVotes.includes(option)} onChange={(e)=>CheckHandler(e.target.value)} />
                                }
                                <div>{option}</div>
                            </div>
                        ))
                ...
                <div className='mt-4 mb-2 flex items-center justify-between'>
                    {
                        !isExpired && <button className='py-[0.35rem] px-4 rounded border border-gray-200 text-black text-sm font-semibold' onClick={()=>setIsEditing(true)}>Edit Response</button>
                    }
