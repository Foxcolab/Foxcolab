  ...
  return (
    ...
    <HeaderFooter>
        ...
        <div className='hp_hero'>
                <div className='my-8'>
                    <div className='uppercase font-semibold text-[0.9rem]'>Evernote vs Foxoclab </div>
                    <div className='text-[2.9rem] my-2 font-bold leading-[2.7rem]'>#1 Business <span className='text-[#E04D6C]'>Evernote</span> alternative</div>
            ...
            <div className='my-8'>
                <div className='text-center font-semibold text-[1.8rem]'>Get more from Evernote alternative
    </div>
