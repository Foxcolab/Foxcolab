...
import TinyMce2 from '../Editor/TinyMce2';
    ...
    <hr />
     ...
     <div className='tt_ss overflow-scroll p-4'>
            <div className="create_ss">
                ...
                <TinyMce setTitle={setName} placeholder='Enter the question..' defaultValue={name} />
                </div>
            ...
            <div className="create_ss">
                ...
                <Input onChange={(e)=>setMarks(parseInt(e.target.value))} defaultValue={1} placeholder='eg. 1 ' className='bg-[#222F3E]' />
            </div>
        <div className="create_ss">
...
<div className="flex items-center space-x-2">
        ...
        <div className="create_ss_editor">
        <TinyMce setTitle={(value:string)=>handleChangeInput(index, value)} placeholder={`Enter the option ${index}`} defaultValue={inputField.value} />
